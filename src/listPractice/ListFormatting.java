...
public class ListFormatting {
     ...
     *       declared an int outside the loop in the previous example.
    ...
    public static String formatWithCommas(List<String> items) {
        ...
        int count = 0;
        for (String words : items) {
            if (count == 0) {
                stringWithCommas = (stringWithCommas + words);
            } else {
                stringWithCommas = (stringWithCommas + ", " + words);
            }
            count +=1;
...
//            if (count == 0) {
//                listWords = listWords + word;
//            } else if (count == items.size() - 1) {
//                listWords = listWords + " and " + word;
//            } else {
//                listWords = listWords + ", " + word;
//            }
//            count += 1;
...
//        return listWords;
//    }
        return formatGrammaticallyTF(items, false);
    }
    /**
...
//        String listWords = formatGrammatically(items);
//        if (listWords.contains(",")) {
//            int andLocation = listWords.indexOf("and");
//            listWords = listWords.substring(0, andLocation - 1) + ", " + listWords.substring(andLocation);
//        }
//        return listWords;
//    }
        return formatGrammaticallyTF(items, true);
    }
     ...
     */
    public static String formatGrammaticallyTF(List<String> items, boolean oxfordComma) {
        String listWords = "";
        int count = 0;
        for (String word : items) {
            if (count == 0) {
