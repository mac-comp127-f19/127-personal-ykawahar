...
public class InkBlot {
    ...
    public void generateInkBlot() {
        ...
        RandomWalk rwX = new RandomWalk(150);
        RandomWalk rwY = new RandomWalk(150);
        RandomWalk rwR = new RandomWalk(150);
        RandomWalk rwG = new RandomWalk(150);
        RandomWalk rwB = new RandomWalk(150);
        Line line = new Line(0, 0, 0, 0);
        for (int i = 0; i < 15000; i++)
            line = advance(rwX, rwY);
            line.setStrokeColor(getColor(rwR, rwG, rwB));
            canvas.add(line);
